        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <main className="flex-1 p-5 md:p-8">
            ...
            <Link
                ...
                className="mb-4 inline-flex items-center gap-2 rounded-xl border border-red-100 bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-500 transition hover:bg-red-100"
              >
                <Trash2 size={16} />
                Deleted Packages
            </Link>
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-3 flex items-center justify-between">
                              ...
                              <div className="flex gap-1">
                                ...
                                <button className="rounded-lg p-2 text-red-400 hover:bg-red-50 hover:text-red-500">
                                  <Trash2 size={16} />
                                </button>
